    ...
    <div>
      <div className="mb-8">
        ...
        <p className="text-vengray text-base">
          The administrator has access to almost all features, except some
          critical organization-level operations.
        </p>
      </div>
      <div className="rolecontentTable">
        ...
        <table className="min-w-full divide-y divide-gray-200  border border-gray-200">
          ...
          <tbody>
           ...
           {/* Change admin popup */}
      {adminModal && <ChangeAdminModal setAdminModal={setAdminModal} title='Assign Administrator' btnTitle='Make admin'/> }
      </div>
    </div>
  );
};
