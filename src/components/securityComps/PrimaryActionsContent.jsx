    ...
    <div>
        <div className="two_factor_auth mb-10">
            <div className='flex items-center gap-8 mb-4'>
                ...
                <div className='flex items-center'><input type="checkbox" id="switch" /><label for="switch">Toggle</label></div>
            </div>
        ...
        <div className="idle_session">
            <div className='flex items-center gap-8 mb-4'>
                ...
                <div className='flex items-center'><input type="checkbox" id="switch2" /><label for="switch2">Toggle</label></div>
            </div>
